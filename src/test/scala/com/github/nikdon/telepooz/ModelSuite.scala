...
class ModelSuite extends CirceSuite with CirceDecoders with CirceEncoders {
  ...
  checkCodec[ReplyKeyboardHide]("ReplyKeyboardHide")
  checkCodec[ReplyKeyboardMarkup]("ReplyKeyboardMarkup")
